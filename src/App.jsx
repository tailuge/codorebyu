  ...
  const renderTree = (node, path = '') => {
    ...
    if (node.isLeaf) {
      return (
        <div 
          key={currentPath}
          className="pl-6 py-1 flex items-center hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer"
    ...
    return (
      <div key={currentPath}>
        <div 
          className="py-1 flex items-center hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer"
    ...
    <div className="flex flex-col h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <header className="bg-indigo-600 text-white p-4 shadow-md">
        <div className="container mx-auto flex justify-between items-center">
          <h1 className="text-2xl font-bold">Code Review App</h1>
          <button 
      ...
      <div className="container mx-auto flex-1 p-4 flex flex-col">
        ...
        <div className="flex-1 flex gap-4 overflow-hidden">
          ...
          <div className="w-1/3 bg-white dark:bg-gray-800 rounded shadow p-4 overflow-auto">
            <h2 className="text-lg font-semibold mb-2 dark:text-white">Repository Structure</h2>
            {folderStructure ? (
              <FileTree 
          ...
          {/* Code viewer */}
          <div className="w-2/3 bg-white dark:bg-gray-800 rounded shadow overflow-hidden flex flex-col">
